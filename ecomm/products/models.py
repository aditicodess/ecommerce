...
class Category(BaseModel):
    ...
    #     kwargs = {
    #         "slug": self.slug or slugify(self.category_name, allow_unicode=True),
    #     }
    #     return reverse("categorys:category_detail", kwargs=kwargs)
...
class Product(BaseModel):
    ...
    def get_absolute_url(self):
        ...
        return reverse("product:product", kwargs=kwargs)
